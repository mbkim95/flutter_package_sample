...
import 'package:kakao_common/kakao_auth_exception.dart';
import 'package:kakao_common/kakao_context.dart';
import 'package:kakao_common/kakao_error.dart';
import 'package:kakao_common/util.dart';
...
class AuthCodeClient {
  ...
  /// Retreives kakao_auth code in web environment. (This method is web specific. Use after checking the platform)
