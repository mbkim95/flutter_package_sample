...
import 'package:kakao_auth/model/access_token_response.dart';
import 'package:kakao_auth/model/cert_token_info.dart';
import 'package:kakao_auth/model/oauth_token.dart';
import 'package:kakao_auth/token_manager.dart';
import 'package:kakao_common/api_factory.dart';
...
class AuthApi {
  ...
  /// Issues temporary agt (access token-generated token), which can be used to acquire kakao_auth code.
